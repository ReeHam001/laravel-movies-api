        ...
        return collect($this->popularActors)->map(function ($actor) {
            return collect($actor)->merge([
                'profile_path' => $actor['profile_path']
                    ? 'https://image.tmdb.org/t/p/w235_and_h235_face' . $actor['profile_path']  // if we find actor image
                    : 'https://ui-avatars.com/api/?size=235&name=' . $actor['name'],                  // else avatar with his name
